...
## Installation:
- Create a folder `[RL]` in `resources`. 
- Put `RL-drivingteacherjob` in to `resources/[RL]`.
- Load this script after target and polyzone.
- in sever.sfg after `[standalone]` add -> `ensure [RL]`
        ...
        items = {
            {
                ...
                icon = 'plus',
                type = 'client',
                event = 'RL-drivingteacherjob:client:giveLicinceMenu',
                shouldClose = true
            },
        }
    },
